About apache-airflow-providers-pagerduty-feedstock
==================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-pagerduty-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-pagerduty-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-pagerduty
# for installing globally
pixi global install apache-airflow-providers-pagerduty
```
...
It is possible to list all of the versions of `apache-airflow-providers-pagerduty` available on your platform:
...
```
pixi search apache-airflow-providers-pagerduty --channel conda-forge
```
